...
public class GearPage extends Utility {
    ...
    public void clickOnBags() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on Bags" + clickOnBag);
    ...
    public void productNameOvernightDuffle() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on product " + overnightDuffle);
    }
    ...
    public void addToCart() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on Add to card" + addToCartButton);
    }
    ...
    public void shoppingCartLinkMessage() {
        ...
        CustomListeners.test.log(Status.PASS, "click on shopping cart" + shoppingCartMessage);
    ...
    public void changeQty5() {
        ...
        CustomListeners.test.log(Status.PASS, "Change Qty to 5" + qty);
        CustomListeners.test.log(Status.PASS, "Click on It" + click);
        CustomListeners.test.log(Status.PASS, "Change Qry to 5" + clean);
    }
    ...
    public void updateShoppingCartButton() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on 'update shopping cart" + updateShoppingCart);
    }
